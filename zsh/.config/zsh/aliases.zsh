...
alias vsc="code --profile Minimal"
alias vscd="code --profile Default"
alias vscf="code --profile Frontend/angular"
alias vscb="code --profile Backend/devops"
alias code-uninstall-all='function _code_uninstall_all() { for profile in "${VSCODE_PROFILES[@]}"; do code --uninstall-extension "$1" --profile "$profile"; done }; _code_uninstall_all'
alias code-install-all='function _code_install_all() { for profile in "${VSCODE_PROFILES[@]}"; do code --install-extension "$1" --profile "$profile"; done }; _code_install_all'
