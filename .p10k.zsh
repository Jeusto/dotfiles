# Generated by Powerlevel10k configuration wizard on 2021-11-06 at 03:21 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_MAX_LENGTH=40
  ...
  # Fix horrific mess that happens on window resize
